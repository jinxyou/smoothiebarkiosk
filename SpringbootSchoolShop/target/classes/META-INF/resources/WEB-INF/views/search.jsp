...
<head>
    ...
    <title>Smoothie Bar-Search${keyword}</title>
...
<div id="main" class="container">
    ...
    <div class="content">
        <div class="module">
            <div class="">
                <h3>
                    Search><span style="color: red;">${keyword}</span>
                </h3>
                <hr>
            </div>
                    ...
                    <ul>
                        <c:forEach items="${pageInfo.list}" var="kiwi">
                            <li class="data-item-li">
                                <div class="to-big">
                                    <a href="${pageContext.request.contextPath}/detail?goodsid=${kiwi.goodsid}"> <img src="${pageContext.request.contextPath}/pictures/${kiwi.imagePaths[0].path}" width="260px" height="260px" alt=""/>
                                    </a>
                                </div>
                                <p class="text-right">
