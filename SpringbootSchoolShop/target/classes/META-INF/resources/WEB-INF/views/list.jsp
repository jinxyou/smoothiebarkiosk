    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabelPsw">Comments</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="updatePsw-form" name="update-form" method="post">
                    <div class="form-group">
                        <label for="star" class="col-sm-2 control-label">Rating</label>
                        <div class="col-sm-9">
...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    <header class="demo-header mdl-layout__header mdl-color--grey-100 mdl-color-text--grey-600">
        <div class="mdl-layout__header-row">
            <span class="mdl-layout-title">Manage orders</span>
                            ...
                            <div class="tab-content col-lg-12">
                                <table class="table " cellpadding="6" cellspacing="1" ><%--订单信息--%>
                                    ...
                                    <td class="no-border col-lg-9" >
                                        Order number：<i name="orderid">${order.orderid}</i>
                                        &nbsp;
                                        &nbsp;
                                        Order date:
                                    ...
                                    <td  class="no-border col-lg-3">
                                        Price:${order.oldprice}  Paid:${order.newprice}
                                    </td>
                                    </tbody>
                                </table>
                    ...
                    <c:forEach items="${orderList}" var="order">
                        <c:if test="${order.issend&&!order.isreceive}">
                            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid" name="parent">
                                ...
                                <div class="mdl-card__actions mdl-card--border">
                                    <button class="templatemo-blue-button " name="finishList"><h5>Finish order</h5></button>
                                </div>
                            </div>
                        </c:if>
                    </c:forEach>
                    ...
                    <c:forEach items="${orderList}" var="order">
                        <c:if test="${order.iscomplete}">
                            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid" name="parent">
                                <div class="tab-content col-lg-12">
                                    ...
                                    <table class="table table-bordered" cellpadding="6" cellspacing="1" ><%--商品信息--%>
                                        ...
                                        <tr>
                                            ...
                                            <td class="col-lg-1">
                                                <button class="mdl-button mdl-js-button mdl-js-ripple-effect font-color" name="evaluate" ><h5>Comment</h5></button>
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="mdl-card__actions mdl-card--border">
                                    <button class="templatemo-blue-button finish-btn" name="deleteList"><h5>Delete</h5></button>
                                </div>
                            </div>
                        </c:if>
                    </c:forEach>
