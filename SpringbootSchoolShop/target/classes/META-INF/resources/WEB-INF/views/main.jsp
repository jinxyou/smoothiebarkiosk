            ...
            <div class="sort">
                <div class="sort-channel">
                    <ul class="sort-channel-list list-group">
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Kiwi">Kiwi</a>
...
<%--                            </div>--%>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Strawberry">Strawberry</a>
<%--                            <div class="sort-detail">--%>
<%--                                <dl class="dl-hor">--%>
<%--                                    <dt>--%>
...
<%--                            </div>--%>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Mango">Mango</a>
<%--                            <div class="sort-detail">--%>
<%--                                <dl class="dl-hor">--%>
<%--                                    <dt>--%>
...
<%--                            </div>--%>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Grape">Grape</a>
<%--                            <div class="sort-detail">--%>
<%--                                <dl class="dl-hor">--%>
<%--                                    <dt>--%>
...
<%--                            </div>--%>
                        ...
                        <li class="list-group-item"><a href="${pageContext.request.contextPath}/category?cate=Other">Other</a>
<%--                            <div class="sort-detail">--%>
<%--                                <dl class="dl-hor">--%>
<%--                                    <dt>--%>
            ...
            <div id="mycarousel" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="item active">
                        <img src="${pageContext.request.contextPath}/image/img.png" alt="">
                    </div>
        ...
        <c:if test="${!empty Kiwi}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${Kiwi}" var="kiwi">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${kiwi.goodsid}"><img src="${pageContext.request.contextPath}/pictures/${kiwi.imagePaths[0].path}" alt=""
                                                                                                                         width="200" height="200"/>
                                        </a>
                                    </div>
                                    <p class="text-right">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${kiwi.goodsid}">${kiwi.goodsname}</a>
                                    </p>
        ...
        <c:if test="${!empty Strawberry}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${Strawberry}" var="strawberry">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${strawberry.goodsid}"> <img
                                                src="${pageContext.request.contextPath}/pictures/${strawberry.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${strawberry.goodsid}">${strawberry.goodsname}</a>
                                    </p>
                                    <div class="text-right">
                                        <b>\$${strawberry.price}</b>
                                    </div>
                                    <div>
                                        <c:if test="${strawberry.fav}">
                                            <button
                                                    class="like-button glyphicon glyphicon-heart btn btn-default"
                                                    data-id="${strawberry.goodsid}"
                                                    style="display: none;"></button>
                                        </c:if>
                                        <c:if test="${!strawberry.fav}">
                                            <button
        ...
        <c:if test="${!empty Mango}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${Mango}" var="mango">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${mango.goodsid}"> <img
                                                src="${pageContext.request.contextPath}/pictures/${mango.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${mango.goodsid}">${mango.goodsname}</a>
                                    </p>
                                    <div class="text-right">
                                        <b>\$${mango.price}</b>
                                    </div>
        ...
        <c:if test="${!empty Grape}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${Grape}" var="grape">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${grape.goodsid}"> <img
                                                src="${pageContext.request.contextPath}/pictures/${grape.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${grape.goodsid}">${grape.goodsname}</a>
                                    </p>
                                    <div class="text-right">
                                        <b>\$${grape.price}</b>
                                    </div>
