        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    ...
                    <div class="form-group">
                        <label for="detailcate" class="col-sm-2 control-label">Subcategory</label>
                        <div class="col-sm-9">
                ...
                <form class="templatemo-login-form">
                    <div class="row form-group">
                        <div class="col-lg-6 form-group">
                            ...
                            <label class="control-label" for="activity-id">Sale number</label>
                    ...
                    <div class="row form-group">
                        <div class="col-lg-6 form-group">
                            <label class="control-label" for="activityname">Sale name</label>
                    ...
                    <div class="row form-group">
                        <div class="col-lg-6 form-group">
                            <label class="control-label" for="fullprice">Buy</label>
                            <span type="number" class="form-control show-span" id="fullprice" name="fullprice"></span>
                        </div>
                        <div class="col-lg-6 form-group">
                            <label class="control-label" for="reduceprice">Discount</label>
                    ...
                    <div class="row form-group">
                        <div class="col-lg-6 form-group">
                            <label class="control-label" for="fullnum">Buy</label>
                            <span type="number" class="form-control show-span" id="fullnum" name="fullnum"></span>
                        </div>
                        <div class="col-lg-6 form-group">
                            <label class="control-label" for="reducenum">Get</label>
                    ...
                    <div class="row form-group">
                        <div class="col-lg-12 form-group">
                            <label class="control-label" for="activitydes">Description</label>
                ...
                <div class="panel panel-default table-responsive">
                    <table id="goodsinfo" class="table table-striped table-bordered templatemo-user-table">
                        ...
                        <tr>
                            ...
                            <td><a href="" class="white-text templatemo-sort-by">Sale<span class="caret"></span></a></td>
                            <td>Detail</td>
                            <td>Edit</td>
                            <td>Delete</td>
                            <td>Sale</td>
