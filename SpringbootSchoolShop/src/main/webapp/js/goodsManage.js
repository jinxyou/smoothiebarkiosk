...
function build_goods_table(path,result) {
    ...
    $.each(goods, function (index,item) {
        ...
        var detailA = $("<a></a>").addClass("templatemo-link").attr("href","/shop/detail?goodsid="+item.goodsid).append("Detail");
...
function build_page_info(path,result) {
    ...
    $("#page-info-area").append("Page #"+ result.info.pageInfo.pageNum +", "+ result.info.pageInfo.pages +" pages total, "+ result.info.pageInfo.total +" records total")
}
