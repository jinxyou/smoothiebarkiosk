                            ...
                            <div class="col-md-6 col-xs-12">
                                <div class="cart_totals ">
                                    ...
                                    <div class="wc-proceed-to-checkout">
                                        <a class="button_act button_act-tc confirm-orders" href="${pageContext.request.contextPath}/order">Submit</a>
                                    </div>
                                </div>
                            </div>
