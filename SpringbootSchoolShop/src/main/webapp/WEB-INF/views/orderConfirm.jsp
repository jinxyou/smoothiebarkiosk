        ...
        <div class="row">
            <div class="col-md-12">
                <div class="account_heading account_heading_ah">
                    <h1 class="header-border">Confirm order</h1>
                </div>
            </div>
        </div>

<%--        确认收货地址--%>
        <h4 class="header-border h4-mar">Choose kiosk to deliver<a href="${pageContext.request.contextPath}/info/address" class="pull-right manage-a">Manage kiosk</a></h4>
        ...
        <%--商品信息--%>
        <h4 class="header-border h4-mar-2">Order info</h4>
        <div class="row">
                    ...
                    <div class="wishlist-content wishlist-content-2">
                        ...
                        <div class="wishlist-table wishlist-table-2 table-responsive">
                            <table id="cart-table">
                                ...
                                <c:forEach items="${goodsAndImage}" var="kiwi">
                                    <tr>
                                        <td class="product-thumbnail product-thumbnail-2"><a
                                                href="${pageContext.request.contextPath}/detail?goodsid=${kiwi.goodsid}"><img
                                                src="${pageContext.request.contextPath}/pictures/${kiwi.imagePaths[0].path}"
                                                alt=""/></a></td>
                                        <td class="product-name product-name_2"><a
                                                href="${pageContext.request.contextPath}/detail?goodsid=${kiwi.goodsid}">${kiwi.goodsname}</a>
                                        </td>
                                        <td class="product-price"><span
                                                class="amount-list amount-list-2">￥${kiwi.price}</span></td>
                                        ...
                                        <td class="product-price"><span
                                                class="amount-list amount-list-2">￥${kiwi.newPrice}</span></td>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-xs-12 form-group form-group-lg">
                                <label class="col-sm-2 control-label" for="pay-select">Payment method</label>
                                <div class="col-sm-10">
                                ...
                                <div class="cart_totals">
                                    ...
                                    <div class="wc-proceed-to-checkout">
                                        ...
                                        <button id="confirm-orders"
                                                class="button_act button_act-tc confirm-orders pull-right">Submit
                                        </button>
                                    </div>
                                </div>
                            </div>
