            ...
            <c:if test="${!empty sessionScope.user}">
                <li class="info-a">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="${pageContext.request.contextPath}/information">Manage account</a></li>
                        <li role="separator" class="divider"></li>
                        <li><a href="${pageContext.request.contextPath}/logout" class="login-out">Log out</a></li>
                    </ul>
                </li>
            </c:if>
    ...
    <nav class="navbar navbar-default" id="header-nav-middle">
        <div class="container-fluid">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="${pageContext.request.contextPath}/main"><!-- <img alt="Brand" style="display: inline-block;" src="./image/tao.jpg" width="20" height="20"> --><span class="logo-word">Smoothie Bar</span></a>
            </div>
            ...
            <div class="collapse navbar-collapse"
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li><a class="a-color" href="${pageContext.request.contextPath}/information">Profile</a></li>
...
<%--                            class="caret"></span></a>--%>
<%--                        <ul class="dropdown-menu">--%>
<%--                            <li><a href="${pageContext.request.contextPath}/info/address">Manage information</a></li>--%>
<%--                            <li><a href="${pageContext.request.contextPath}/order">Order in progress</a></li>--%>
<%--                            <li role="separator" class="divider"></li>--%>
<%--                        </ul></li>--%>
                </ul>
