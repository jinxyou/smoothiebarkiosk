...
<div class="modal fade" id="update-Psw" tabindex="-1" role="dialog" aria-labelledby="myModalLabelPsw">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="myModalLabelPsw">Change password</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" id="updatePsw-form" name="update-form" method="post">
                    <div class="form-group">
                        <label for="oldPsw" class="col-sm-2 control-label">Old password</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group" style="display: none" id="oldPswError">
                        ...
                        <div class="col-sm-9">
                            <label style="color: #BD1F3B">Wrong old password</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="newPsw" class="col-sm-2 control-label">New password</label>
                        <div class="col-sm-9">
                    ...
                    <div class="form-group" style="display: none" id="newPswError">
                        <label for="name" class="col-sm-2 control-label"></label>
                        <div class="col-sm-9">
                            <label style="color: #BD1F3B">New password must have at least length of 8.</label>
                        </div>
                    </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                <button type="button" class="btn btn-primary" id="savePsw" >Save</button>
            </div>
        </div>
    </div>
</div>
...
<div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
    ...
    <div class="demo-drawer mdl-layout__drawer mdl-color--blue-grey-900 mdl-color-text--blue-grey-50">
        ...
        <nav class="demo-navigation mdl-navigation mdl-color--blue-grey-800">
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/main"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">home</i>Home</a>
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/information"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">inbox</i>Profile</a>
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/info/list"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">forum</i>Manage orders</a>
            <%--            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/info/address"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">local_offer</i>Manage address</a>--%>
            <a class="mdl-navigation__link" href="${pageContext.request.contextPath}/info/favorite"><i class="mdl-color-text--blue-grey-400 material-icons" role="presentation">flag</i>My favorites</a>
        </nav>
    </div>
            ...
            <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
                <div class="tab-content">
                        <table class="table" cellpadding="6" cellspacing="1">
                            ...
                            <tbody >
                            <tr >
                                <th style="border: 0px solid transparent" class="tl">UserID</th>
                                <td style="border: 0px solid transparent" class="tr" id="userIdVal">${user.getUserid()}</td>
                            </tr>
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">Username</th>
                                <td style="border: 0px solid transparent" class="tr" id="nameVal">${user.getUsername()}</td>
                            </tr>
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">Sign up date</th>
                            ...
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">Email</th>
                                <td style="border: 0px solid transparent" class="tr" id="emailVal">${user.getEmail()}</td>
                            </tr>
                            <tr>
                                <th style="border: 0px solid transparent" class="tl">Telephone</th>
                ...
                <div class="mdl-card__actions mdl-card--border">
                    <button class="templatemo-blue-button" id="changeInfo"><h5>Modify info</h5></button>
                    <button class="templatemo-blue-button" id="changePsw"><h5>Change password</h5></button>
                </div>
            </div>
        </div>
    </main>
