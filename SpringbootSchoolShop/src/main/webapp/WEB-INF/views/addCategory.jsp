    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="saveCatename" >Save</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            ...
            <div class="templatemo-content-widget white-bg">
                        ...
                        <table id="goodsinfo" class="table  table-bordered templatemo-user-table">
                            ...
                            <c:forEach items="${categoryList}" var="category">
                                <tr>
                                    ...
                                    <td><button href="" class="templatemo-edit-btn" name="changCate">Edit</button></td>
                                    <td><button href="" class="templatemo-delete-btn" name="deleteCate">Delete</button></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
                ...
                <label class="control-label" for="catename">Add category</label>
