...
<head>
    ...
    <title>Smoothie Bar-${goodsInfo['goods'].goodsname}</title>
        ...
        $(document).ready(function () {
            ...
            $('.fav-button').click(function(){
                ...
                if(isChangeBtn) {
                    ...
                    if(likeContent == 'Favorite'){
                        $(this).children("span").text('Cancel favorite');
                    } else {
                        $(this).children("span").text('Favorite');
                    }
                }
            });
        });
    ...
    <div class="container">
        ...
        <div class="shop_menu shop_menu_2 main-detail-div">
            <ul class="cramb_area cramb_area_5 main-detail-nav">
                <li><a href="/shop/main">Index /</a></li>
...
<%--                                    <span class="span-block">Discount:${goodsInfo['goods'].activity.discount}</span>--%>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12 text-right">
                <div class="my-tabs">
                    ...
                    <ul class="favtabs favtabs-2 favtabs-nytr" role="tablist">
                        ...
                        <li role="presentation"><a href="#profile" aria-controls="profile" role="tab" data-toggle="tab">Comments
                            </a></li>
                    </ul>
                    <!-- Tab panes -->
                                ...
                                <div class="col-md-12 col-xs-12">
                                    <div class="tb_desc">
                                        <div class="review_area_heading">
                                            <div id="comnt">
                                                <h2>${commentList.size()}Comment(s)</h2>
