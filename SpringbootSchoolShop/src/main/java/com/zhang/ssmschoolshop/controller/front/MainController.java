...
public class  MainController {
    ...
    public String showAdmin(Model model, HttpSession session) {
        ...
        //数码分类
        List<Goods> digGoods = getCateGoods("Kiwi", userid);
        model.addAttribute("Kiwi", digGoods);

        //家电
        List<Goods> houseGoods = getCateGoods("Strawberry", userid);
        model.addAttribute("Strawberry", houseGoods);

        //服饰
        List<Goods> colGoods = getCateGoods("Mango", userid);
        model.addAttribute("Mango", colGoods);

        //书籍
        List<Goods> bookGoods = getCateGoods("Grape", userid);
        model.addAttribute("Grape", bookGoods);
