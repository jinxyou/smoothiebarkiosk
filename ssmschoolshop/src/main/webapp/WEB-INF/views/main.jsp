        ...
        <c:if test="${!empty digGoods}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${digGoods}" var="kiwi">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${kiwi.goodsid}"><img src="/pictures/${kiwi.imagePaths[0].path}" alt=""
        ...
        <c:if test="${!empty houseGoods}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${houseGoods}" var="strawberry">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${strawberry.goodsid}"> <img
                                                src="/pictures/${strawberry.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
        ...
        <c:if test="${!empty colGoods}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${colGoods}" var="mango">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${mango.goodsid}"> <img
                                                src="/pictures/${mango.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
        ...
        <c:if test="${!empty bookGoods}">
            <div class="module">
                ...
                <div class="bd">
                    <div class="data">
                        <ul>
                            <c:forEach items="${bookGoods}" var="grape">
                                <li class="data-item-li">
                                    <div class="to-big">
                                        <a href="${pageContext.request.contextPath}/detail?goodsid=${grape.goodsid}"> <img
                                                src="/pictures/${grape.imagePaths[0].path}" alt=""
                                                width="200" height="200">
                                        </a>
                                    </div>
                                    <p class="text-right">
